...
### Backend Devs
- Alessio Divizia (Team leader, Referente Backend): @Lelpoco2
- Luca Dipasquale: @LucaDipa11
- Denis Angelo Oniga: @Denisang
### Frontend Devs
- Gloria Paita (Referente Frontend) : @Gloria-Pi
- Alessandro Scattaglia: @Alessandro-Scattaglia
- Cosmin Grosu: @Cosmin04729
### Digital Strategist
- Nicole Andrade (Referente Digital Strategy): @nicoleandrade29
- Antonio Perri: 
- Gaia Medicini: @gaiamedicini-rgb
...
## 4. Struttura del repository (work in progress)
